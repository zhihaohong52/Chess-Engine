...
/**
 * @brief Enum to store the files
 *
 */
enum { FILE_A, FILE_B, FILE_C, FILE_D, FILE_E, FILE_F, FILE_G, FILE_H, FILE_NONE };

/**
 * @brief Enum to store the ranks
 *
 */
enum { RANK_1, RANK_2, RANK_3, RANK_4, RANK_5, RANK_6, RANK_7, RANK_8, RANK_NONE };

/**
 * @brief Enum to store the colors
 *
 */
...
/**
 * @brief Enum to store boolean values
 *
 */
enum { FALSE, TRUE };

/**
 * @brief Enum to store the castling permissions
 *
 */
enum { WKCA = 1, WQCA = 2, BKCA = 4, BQCA = 8 };

/**
 * @brief Structure to store a move
 *
 */
typedef struct {
    int move;
...
/**
 * @brief Structure to store a list of moves
 *
 */
typedef struct {
...
/**
 * @brief Structure to store the board
 *
 */
typedef struct {
    ...
    int material[2]; // Material value of pieces
