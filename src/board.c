...
/**
 * @brief Checks if board is valid
 *
 * @param pos S_BOARD pointer
 * @return int TRUE if board is valid, FALSE otherwise
 */
...
/**
 * @brief Update the material list
 *
 * @param pos S_BOARD pointer
 */
