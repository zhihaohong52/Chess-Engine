 ...
 * @file makemove.c
 * @author zhihaohong52
 * @brief Contains functions to make moves
 * @version 0.2
 * @date 2024-04-30
 *
...
/**
 * @brief Array to store castle permissions
 *
 */
...
/**
 * @brief Function to clear a piece from the board
 *
 ...
 *
 * @param sq Square to add the piece
 * @param pos Pointer to the board
 ...
 * @return int TRUE if move is made, FALSE if move leaves king in check
 */
...
/**
 * @brief Function to make a null move
 *
 * @param pos Pointer to the board
 */
...
/**
 * @brief Function to take back a null move
 *
 * @param pos Pointer to the board
 */
